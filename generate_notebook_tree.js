...
if (nbResizer && notebookTreeContainer) {
    nbResizer.addEventListener('mousedown', () => { isNbResizing = true; });
    ...
    document.addEventListener('mouseup', () => { isNbResizing = false; });
}
...
fs.writeFileSync('notebook_tree.js', code);
